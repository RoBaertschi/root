...
compose_compile_flag :: enum c.int {
    /** Do not apply any flags. */
    NO_FLAGS,
}

compose_compile_flags :: bit_set[compose_compile_flag; c.int]
 ...
 */
	compose_table_new_from_locale :: proc(ctx: ^context_, locale: cstring, flags: compose_compile_flags) -> ^compose_table ---
 ...
 * @memberof xkb_compose_table
 */
	compose_table_new_from_file :: proc(ctx: ^context_, file: ^c.FILE, locale: cstring, format: compose_format, flags: compose_compile_flags) -> ^compose_table ---
 ...
 * @memberof xkb_compose_table
 */
	compose_table_new_from_buffer :: proc(ctx: ^context_, buffer: cstring, length: c.size_t, locale: cstring, format: compose_format, flags: compose_compile_flags) -> ^compose_table ---
 ...
 * @since 1.6.0
 */
	compose_table_entry_sequence :: proc(entry: ^compose_table_entry, sequence_length: ^c.size_t) -> [^]keysym_t ---
...
compose_state_flag :: enum c.int {
    /** Do not apply any flags. */
    NO_FLAGS,
}

compose_state_flags :: bit_set[compose_state_flag; c.int]
 ...
 * @memberof xkb_compose_state
 */
	compose_state_ref :: proc(s: ^compose_state) -> ^compose_state ---
 ...
 * @memberof xkb_compose_state
 */
	compose_state_unref :: proc(s: ^compose_state) ---
 ...
 * @memberof xkb_compose_state
 */
	compose_state_get_compose_table :: proc(s: ^compose_state) -> ^compose_table ---
 ...
 * @memberof xkb_compose_state
 */
	compose_state_feed :: proc(s: ^compose_state, keysym: keysym_t) -> compose_feed_result ---
 ...
 * @memberof xkb_compose_state
 */
	compose_state_reset :: proc(s: ^compose_state) ---
 ...
 * @memberof xkb_compose_state
 **/
	compose_state_get_status :: proc(s: ^compose_state) -> compose_status ---
 ...
 * @memberof xkb_compose_state
 **/
	compose_state_get_utf8 :: proc(s: ^compose_state, buffer: [^]c.char, size: c.size_t) -> c.int ---
 ...
 * @memberof xkb_compose_state
 **/
	compose_state_get_one_sym :: proc(s: ^compose_state) -> keysym_t ---
